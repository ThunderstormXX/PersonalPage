...
\end{itemize}
    ...
    \begin{itemize}
        ...
        \item Collaborating with \href{https://scholar.google.com/citations?user=RNnvD3wAAAAJ\&hl=en}{Andrei Leonidov's group} on SGD analysis and multi-agent reinforcement learning, including studying noise in SGD, developing theoretical frameworks for non-convex optimization dynamics, and conducting joint research on multi-agent LLM systems in game-theoretic scenarios and social dilemmas.
