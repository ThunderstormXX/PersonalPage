...
\begin{itemize}
    ...
    \item ML/Optimization: PyTorch, JAX, vLLM, TRL, RL, LLMs, convex and nonconvex optimization, game theory
...
\end{itemize}
    ...
    \begin{itemize}
        ...
        \item Currently developing LLM inference acceleration and distillation projects, including a vLLM-based early-exit and adaptive-decoding evaluation pipeline, and a Qwen/DeepScaleR math post-training pipeline with teacher-generated SFT data, reward parsing, RLVR/GRPO-style training, and benchmark reporting.
